...
from .views import employees_api, employee_api, projects_api, project_api, assignments_api, assignment_api, list_models


urlpatterns = [
    # API entry points should be defined here
    path("listTypes", list_models, name="List Models"),
